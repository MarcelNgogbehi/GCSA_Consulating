...
export const PROGRAMMES = {
  "transition-to-architecture": {
    ...
    // Hosted Stripe Payment Link — registration redirects here to pay.
    // (No Stripe API/secret key needed for the payment itself.)
    paymentLink: "https://buy.stripe.com/6oU3coa0lbfh7wC8ZP0Ba01",
